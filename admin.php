        ...
        <div class="wrapper">
            <ul id="content">
                ...
                <li class="content-li">
                    <form action="">
                        <h3>
                        <span class="user-name"><input type="text" placeholder="Add Username"></span>
                        <span class="user-passwd"><input type="text" placeholder="Add Password"></span>
                        <span class="user-add"><button class="mybtn add-btn">Add <i class="fa fa-plus-square"></i></button></span>
                    </h3>
                    </form>
                    <h3>
                        <span>account</span>
